(function(global) {
  ...
  describe('PromisePool', function() {
    describe('constructor', function() {
      it('should accept a non-function as the producer', function() {
        var poolPromise = new PromisePool('test', 1).start();
        return expect(poolPromise).to.be.fulfilled;
      });

      it('should accept a single promise as the producer', function() {
      ...
      if (supportsGenerators) {
        var gen = eval('(function* g() {' +
          ...
          '});' +
          '})');
        it('should accept a generator as the producer', function() {
    ...
    describe('#start()', function() {
      ...
      it('should not call the producer after settling', function() {
        var maxCnt = 0;
        var cnt = 0;
    ...
    describe('#concurrency()', function() {
      ...
      it('should increase the pool size', function() {
        var size;
        var cnt = 0;
        var pool = new PromisePool(function() {
          if (cnt++ < 10) {
      ...
      it('should not change the pool size after fulfilment', function() {
    ...
    describe('#active()', function() {
      it('should report inactivity by default', function() {
        var pool = new PromisePool(Promise.resolve(), 3);
        expect(pool.active()).to.equal(false);
      });

      it('should report activity while working', function() {
        var called = false;
        var pool = new PromisePool(function() {
          if (called) {
            return null;
      ...
      it('should report inactivity after fulfilment', function() {
        var pool = new PromisePool(Promise.resolve(), 3);
        var poolPromise = pool.start();
    ...
    describe('#promise()', function() {
      it('should not return a promise by default', function() {
        var pool = new PromisePool(Promise.resolve(), 3);
        expect(pool.promise()).to.not.exist;
      });

      it('should return a promise while working', function() {
        var called = false;
        var pool = new PromisePool(function() {
          if (called) {
            return null;
      ...
      it('should not return a promise after fulfilment', function() {
        var pool = new PromisePool(Promise.resolve(), 3);
        var poolPromise = pool.start();
    ...
    describe('fulfilment', function() {
      it('should happen on an empty pool', function() {
        var poolPromise = new PromisePool(function() {
          return null;
        }, 1).start();
      ...
      it('should happen on a delayed promise', function() {
        var called = false;
        var poolPromise = new PromisePool(function() {
          if (called) {
            return null;
    ...
    describe('rejection', function() {
      it('should be forwarded', function() {
        var poolPromise = new PromisePool(function() {
          return new Promise(function(resolve, reject) {
      ...
      it('should always provide an Error', function() {
        var poolPromise = new PromisePool(function() {
          return new Promise(function(resolve, reject) {
            reject();
          });
      ...
      it('should not cause fulfilment', function() {
        var reached = false;
        var cnt = 0;
        var pool = new PromisePool(function() {
          switch (cnt++) {
      ...
      it('should not happen multiple times', function() {
        var rejections = 0;
        var cnt = 0;
        var pool = new PromisePool(function() {
          switch (cnt++) {
    ...
    describe('events', function() {
      it('should fire fulfilled upon fulfillment', function() {
        var arg = null;
        var res = 'test';
      ...
      it('should fire rejected upon rejection', function() {
        var arg = null;
